...
// Sibling de /api/news/today consumido por el bot MT5 (Module 11 - News).
// Autenticado por header x-bot-api-key contra la env var BOT_API_KEY.
// Devuelve exactamente el mismo shape que /api/news/today.
